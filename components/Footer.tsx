...
export default function Footer({}: Props) {
  return (
    <div className='px-8 py-12 md:px-48 bg-cream flex flex-col items-start justify-center gap-6 text-dark'>
        ...
        <p className='text-[#646461] text-sm'>Designed by <a className='underline decoration-outlive-blue underline-offset-2 underline-2 hover:text-dark transition duration-300 ease-in-out' href='https://namanchandok.github.io'>Naman Chandok</a></p>
    </div>
  )
}