  ...
  return (
    <div className={cabin.className + ' w-screen bg-cream px-8 py-12 md:py-24 text-center md:px-48'}>
        ...
        <div className='grid md:grid-cols-4 justify-center gap-12 pt-16'>
          <div>
            <img src="team1.png" className='aspect-square object-cover rounded-full w-52 mx-auto' alt="John Doe" />
          ...
          <div>
            ...
            <p className='text-outlive-blue'>Tech Head</p>
          </div>
          <div>
            <img src="team1.png" className='aspect-square object-cover rounded-full w-52 mx-auto' alt="John Doe" />
            <h3 className='text-3xl font-primary pt-4'>Amayra Channa</h3>
            <p className='text-outlive-blue'>Head of Social Media</p>
          </div>
        </div>
    </div>
  )
